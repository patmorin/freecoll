...
As a first step, we impose % consider solutions to $A\cdot s=b$ that
                           % satisfy 
some
...
We are left with the case that $Q$ is a 2-connected \emph{near-quadrangulation} whose outer face 
   is a simple cycle $F$, see \figref{lemma-y}.
...
This completes the proof of \thmref{quad}.  We have
