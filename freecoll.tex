...
\begin{lem}\lemlabel{split-edges}
  ...
  Then, in the drawing of $Q$ produced by \thmref{quad}, the distance between $x$ and $y$ is at most $4\sqrt{2}\epsilon/g$.
\end{lem}
...
\begin{proof}[Proof sketch]
   ...
   This works because \lemref{split-edges} ensures two things:
   \begin{enumerate}
