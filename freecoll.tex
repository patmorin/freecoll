...
\begin{proof}
   ...
   edges.  We can then use the results from \secref{quadrangulations}
   ...
   of crossing edges.  This is still insufficient to apply \lemref{quad},
   since \lemref{quad} requires that the curve $C$ does not contain any
   ...
   edges $e_1,\ldots,e_d$ in exactly one point.  Now, to apply \lemref{quad} we must specify numbers $y_1',\ldots,y_d'$ where $(0,y_i')$ is the intersection point between $e_j$ and the y-axis.  To do this, we can 
