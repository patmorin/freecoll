...
\begin{proof}
  ...
  Each outgoing edge
  $e_i=\vec{vw}$ of $v$ is of one of five types, which we presented in counterclockwise order around $v$ (see \figref{five-types}):
   \begin{figure}[htbp]
  ...
  the case of Type~4 edges discussed above.
