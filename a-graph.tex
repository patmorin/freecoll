...
merging it into the outer face, see \figref{lemma-y-3}.
  ...
  \begin{figure}
     ...
     \caption{The proof of \lemref{partition-extended} for a vertex
       $v$ on $C$.}
     \figlabel{lemma-y-3}
  \end{figure}
...
$F$ contains at least four vertices, and $C$ intersects
   ...
   an inner face through $vw$, see \figref{lemma-y}.
  ...
  \begin{figure}
     ...
     \caption{The proof of \lemref{partition-extended}, for a reflex
       vertex $v$.}
     \figlabel{lemma-y-4}
  \end{figure}
