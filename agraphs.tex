...
\begin{figure}
   ...
   \caption{The three possibilities for the outer face in \thmref{a-graph}.}
...
vertex $v$ will include many redundant equations. Indeed, it suffices to take $d_v-2$ equations: For each vertex $v\in V(G)$, we choose two fixed
...
%		contains $(0,y_i)$.
		...
		Finally, Property~(PR4) follows from the ordering
