...
straight-line embedding of $G$ becomes noncrossing. The goal is to do so while
\emph{keeping fixed}
...
Tutte's Convex Embedding Theorem~\cite{tutte:how}
to suitable augmentations
of these graphs.
This theorem
gives a plane
straight-line embedding of an internally 3-connected graph, with the vertices
...
subproblem is the one in which $G$ is an embedded graph where every
